...
describe('OrderStatusChart Widget', function (): void {
    ...
    it('includes all order statuses in labels', function (): void {
        $widget = new OrderStatusChart;
        $reflection = new ReflectionMethod($widget, 'getData');
        $data = $reflection->invoke($widget);
        $labels = $data['labels'];
    ...
    it('counts orders by status', function (): void {
    ...
    it('dataset has background colors', function (): void {
        $widget = new OrderStatusChart;
        $reflection = new ReflectionMethod($widget, 'getData');
        $data = $reflection->invoke($widget);
    ...
    it('dataset has border colors', function (): void {
        $widget = new OrderStatusChart;
        $reflection = new ReflectionMethod($widget, 'getData');
        $data = $reflection->invoke($widget);
