    ...
    <body style="background-color: #dee3e0">
        <div style="margin: auto; background-color: white; padding: 2em">
            ...
            <div class="margin-bottom: 2em;">
                <h1 style="font-weight: 700; font-size: 2em">Contacto a través del formulario</h1>
            </div>
            <!-- Transaction Details -->
            <div>
                <p class="mb-2 text-gray-700" style="color: #464746; margin-bottom: 1em">
                    <strong>Nombre:</strong>
                    {{ ' ' . $name }}
                </p>
                <p style="color: #464746; margin-bottom: 1em">
                    <strong>Email:</strong>
                    {{ ' ' . $email }}
                </p>
